...
class ${constructor(e,t){this.context=e,this.receiver=t,this.stringMapObserver=new N(this.element,this),this.valueDescriptorMap=this.controller.valueDescriptorMap}
start
...
class L {
    ...
    setupSelectorObserverForOutlet(e) {
        const t = this.selector(e), s = new k(document.body, t, this, {outletName: e});
...
class U {
    constructor(e, t) {
        this.application = e, this.definition = function (e) {
            return {identifier: e.identifier, controllerConstructor: K(e.controllerConstructor)}
...
function te([e, t], s) {
    return function (e) {
        const {token: t, typeDefinition: s} = e, r = `${c(t)}-value`, n = function (e) {
            const {controller: t, token: s, typeDefinition: r} = e, n = {controller: t, token: s, typeObject: r},
                i = function (e) {
                    const {controller: t, token: s, typeObject: r} = e, n = l(r.type), i = l(r.default), o = n && i,
                        a = n && !i, c = !n && i, h = se(r.type), u = re(e.typeObject.default);
                    if (a) return h;
                    if (c) return u;
                    if (h !== u) {
        ...
        return {
            type: n, key: r, name: i(r), get defaultValue() {
                return function (e) {
                    const t = se(e);
                    if (t) return ne[t];
                    const s = h(e, "default"), r = h(e, "type"), n = e;
                    if (s) return n.default;
                    if (r) {
                        const {type: e} = n, t = se(e);
                        if (t) return ne[t]
                    }
                    return e
                }(s)
                ...
                return void 0 !== re(s)
            }, reader: ie[n], writer: oe[n] || oe.default
        }
...
ce.blessings = [function (e) {
    ...
    const t = x(e, "values"), s = {
        valueDescriptorMap: {
            get() {
                return t.reduce(((e, t) => {
                    const s = te(t, this.identifier), r = this.data.getAttributeNameForKey(s.key);
    ...
    return t.reduce(((e, t) => Object.assign(e, function (e, t) {
        const s = te(e, t), {key: r, name: n, reader: i, writer: o} = s;
        return {
            [n]: {
                get() {
